        ...
        <div class="col-md-6">
            ...
            <form @submit.prevent="handleSubmitForm">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" v-model="freelancerProject.jobCategory">
  ...
  export default {
    ...
    methods: {
        handleUpdateForm() {
            ...
            axios.put(apiURL, this.freelancerProject).then(() => {
              var activity = {
                      activityDescription: "Project '" + this.freelancerProject.projectName + "' was edited",
